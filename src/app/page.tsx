...
export default function Home() {
  return (
    <section className="px-4 bg-purple-600 blur-3xl">
      <div className="bg-linear-to-br from-sky-400 via-sky-400 to-violet-400 p-6 sm:p-10 rounded-2xl w-full text-white flex items-center justify-between max-w-2xl mx-auto mt-20">
